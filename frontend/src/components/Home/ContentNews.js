...
const ContentNews = (props) => {
  ...
  useEffect(() => {
    ...
    let parentNews = [];
    if (News) {
      parentNews = News.filter((value) => value.name === 'MỚI');
    }
                    ...
                    {img.length !== 0 ? (
                        <div className="col-lg-3">
                            <div
                                ...
                                style={{
                                    backgroundImage: `url(http://localhost:8080/uploads/images/${img[0].image})`,
                                }}
                            >
                                <h2>{img[0].title}</h2>
                      ...
                      >
                        ...
                        <Link
                          ...
                          <div className="imgfit">
                            <img
                              src={`http://localhost:8080/uploads/posts/${checkImage(
                                key
                              )}`}
                              alt="画像" />
                          </div>
