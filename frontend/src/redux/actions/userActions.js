...
export const getUser = (id) => async (dispatch) => {
    try {
        ...
        dispatch({
            type: SET_ROLE,
            payload: res.data && res.data.role === 1 ? true : false,
        });
    } catch (e) {
        console.log(e);
    }
...
export const login = (data) => async (dispatch) => {
    ...
    try {
        ...
        if (res.data.info) {
            ...
            dispatch({
                type: SET_ROLE,
                payload: res.data.info && res.data.info.role === 1 ? true : false,
            });
            document.location.href = '/';
        } else {
            dispatch({
...
export const openGoogle = () => async (dispatch) => {
    try {
        window.open('http://localhost:8080/api/user/login-google', '_self');
    } catch (e) {
        console.log(e);
    }
};
...
export const openFacebook = () => async (dispatch) => {
    try {
        window.open('http://localhost:8080/api/user/login-facebook', '_self');
    } catch (e) {
        console.log(e);
    }
};
